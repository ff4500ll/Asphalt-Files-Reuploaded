    ...
    def main_loop(self):
        ...
        with mss.mss() as sct:
            ...
            while self.main_loop_active:
                ...
                # Define the temp area (with real width but full overlay height)
                temp_monitor = {
                    "left": temp_area_x,
                    "top": y,
                ...
                # Define the real area monitor region
                real_monitor = {
                    "left": real_x,
                    "top": real_y,
                    "width": real_width,
                ...
                if dark_sections and white_top_y is not None:
                    ...
                    error = largest_section['middle'] - white_top_y
                    ...
                    print(f"Error: {error}, PD Output: {pd_output:.2f}")
