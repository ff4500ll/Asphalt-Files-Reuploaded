...
def fish_bot():
    ...
    move_check_movement_threshold_percent = 0.005  # Movement threshold as % of fish area width (0.5% = ~5px at 1032px)
    ...
    deadband_percent = 0.0  # Deadband as % of fish area width (0 = no deadband)
    deadband_velocity_threshold_percent = 0.05  # Velocity threshold for deadband hover as % of width (~50px/s at 1032px)
    ...
    panic_large_error_percent = 0.05  # Distance considered "far from target" as % of width (5% = ~50px at 1032px)
    panic_high_velocity_percent = 0.77  # Velocity threshold to keep panic active as % of width (~800px/s at 1032px)
    
    # Visual overlay
    show_overlay = True  # Set to False to disable visual arrows
    
    # ============================================================================
    # CALCULATED VALUES (derived from fish area width)
    # ============================================================================
    
    # Calculate pixel values based on fish area width for resolution independence
