...
class CastView(ctk.CTkFrame):
    ...
    def _tune_last_cast(self, direction):
        ...
        # Map band index to setting key
        band_settings = [
            "perfect_cast_band1_release",  # <400
            "perfect_cast_band2_release",  # 400-600
            "perfect_cast_band3_release",  # 600-800
            "perfect_cast_band4_release",  # 800-1000
            "perfect_cast_band5_release",  # 1000-1200
            "perfect_cast_band6_release",  # >1200
        ]
