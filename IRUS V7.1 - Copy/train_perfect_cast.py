...
class PerfectCastModelTrainer:
    def __init__(self):
        # Paths
        self.base_dir = os.path.dirname(__file__)
        self.dataset_path = os.path.join(self.base_dir, "Images", "Processed", "Perfect Cast")
        self.model_save_path = os.path.join(self.base_dir, "perfect_cast_model.pt")

        print("=" * 60)
        print("YOLO Model Training - Perfect Cast Detection")
        print("=" * 60)
    ...
    def create_data_yaml(self):
        ...
        yaml_content = f"""# Dataset configuration for YOLO - Perfect Cast Detection
...
"""
    ...
    def train_model(self, epochs=100, batch=16, imgsz=640, device='cpu'):
        ...
        try:
            ...
            results = model.train(
                ...
                translate=0.1,  # 10% position shift
            ...
            best_model_path = os.path.join(self.base_dir, 'runs', 'perfect_cast_detection', 'weights', 'best.pt')
            ...
            print("\n✅ Training complete!")
            print(f"\nTraining results saved in: {os.path.join(self.base_dir, 'runs', 'perfect_cast_detection')}")
    ...
    def run(self):
        ...
        if success:
            ...
            print("=" * 60)
            print(f"\nYou can now use the trained model '{self.model_save_path}' for perfect cast detection.")
        else:
            print("\n" + "=" * 60)
...
def main():
    trainer = PerfectCastModelTrainer()
    trainer.run()
